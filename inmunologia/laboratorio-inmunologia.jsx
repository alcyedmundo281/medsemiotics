// Fuente del módulo interactivo de laboratorio-inmunologia.html.
// Se compila con `npm run build:js` a laboratorio-inmunologia.bundle.js; la página carga
    ...
    <div className="animate-fade-in space-y-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-purple-100 border-t-4 border-t-purple-600">
            ...
            <div className="mb-6 rounded-lg overflow-hidden border border-slate-200 shadow-sm">
                <img src="../assets/images/ana_staining_patterns_pic.png" alt="Patrones ANA de UpToDate" className="w-full h-auto" />
...
const AutoantibodyTable = () => {
    return (
        <div className="animate-fade-in bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            ...
            <div className="mb-6 rounded-lg overflow-hidden border border-slate-200 shadow-sm">
                <img src="../assets/images/ana_disease_associations_table.png" alt="Asociaciones ANA de UpToDate" className="w-full h-auto max-h-[500px] object-contain bg-white" />
