...
function yr(e, n, t, r, l) {
  ...
  if (((i = 0), (r = r === '' ? '.' : r + ':'), Di(e)))
    ...
    for (e = s.call(e), u = 0; !(o = e.next()).done; )
      ((o = o.value), (s = r + gl(o, u++)), (i += yr(o, n, t, s, l)));
  else if (o === 'object')
    throw (
      (n = String(e)),
      Error(
    ...
    (e.unstable_scheduleCallback = function (C, z, L) {
      ...
      return (
        ...
        L > W
          ...
          : ((C.sortIndex = G), n(s, C), w || g || ((w = !0), hl(E))),
        C
      );
    }),
...
function $c(e, n, t, r, l, o, i, u, s) {
  ((xt = !1), (jr = null), Fc.apply(Uc, arguments));
}
...
function ef(e, n, t, r, l) {
  switch (n) {
    ...
    case 'pointerover':
      var o = l.pointerId;
      return (It.set(o, ft(It.get(o) || null, e, n, t, r, l)), !0);
    case 'gotpointercapture':
      return (
        (o = l.pointerId),
...
function wr(e) {
  ...
  for (var n = e.targetContainers; 0 < n.length; ) {
    ...
    } else return ((n = Zt(t)), n !== null && bo(n), (e.blockedOn = t), !1);
    n.shift();
  }
  return !0;
}
...
function ei(e, n, t, r) {
  if (Or) {
    var l = co(e, n, t, r);
    if (l === null) (Il(e, n, r, Mr, t), Xi(e, r));
    else if (ef(l, e, n, t, r)) r.stopPropagation();
    else if ((Xi(e, r), n & 4 && -1 < bc.indexOf(e))) {
      for (; l !== null; ) {
        var o = Zt(l);
        if (
          (o !== null && Ls(o),
          (o = co(e, n, t, r)),
          o === null && Il(e, n, r, Mr, t),
          o === l)
        )
          break;
        l = o;
...
var Mr = null;
function co(e, n, t, r) {
  if (((Mr = null), (e = Zo(r)), (e = kn(e)), e !== null))
...
var ot = {
  ...
  Ji = we(nl),
  of = A({}, nl, { dataTransfer: 0 }),
  uf = we(of),
  sf = A({}, Gt, { relatedTarget: 0 }),
  Nl = we(sf),
...
function lu() {
  Ct && (Ct.detachEvent('onpropertychange', As), (Dt = Ct = null));
}
function As(e) {
  if (e.propertyName === 'value' && tl(Dt)) {
    var n = [];
    ($s(n, Dt, e, Zo(e)), ks(Rf, n));
  }
}
function Of(e, n, t) {
  e === 'focusin'
    ? (lu(), (Ct = n), (Dt = t), Ct.attachEvent('onpropertychange', As))
    : e === 'focusout' && lu();
}
function Mf(e) {
...
for (var jl = 0; jl < su.length; jl++) {
  var Tl = su[jl],
    Af = Tl.toLowerCase(),
    Bf = Tl[0].toUpperCase() + Tl.slice(1);
  pn(Af, 'on' + Bf);
}
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = Rt(a, f)), v != null && S.push($t(a, v, d)))),
            F)
          )
            break;
          a = a.return;
...
function cu(e, n, t, r, l) {
  for (var o = n._reactName, i = []; t !== null && t !== r; ) {
    ...
    (u.tag === 5 &&
      ...
      ((u = c),
      l
        ? ((s = Rt(t, o)), s != null && i.unshift($t(t, s, u)))
        : l || ((s = Rt(t, o)), s != null && i.push($t(t, s, u)))),
      (t = t.return));
  }
...
function ra(e) {
  ...
  function S(f, a, d, v) {
    ...
    for (
      var _ = (E = null), N = a, P = (a = 0), H = null, T = d.next();
      N !== null && !T.done;
      P++, T = d.next()
    ) {
      N.index > P ? ((H = N), (N = null)) : (H = N.sibling);
...
function mi(e, n) {
  switch ((O(Bt, n), O(At, e), O(Ue, Jt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function xa(e, n, t) {
  return Pn & 21
    ? (Ie(t, n) || ((t = Ps()), (V.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function td(e, n, t) {
  ...
  if (Ca(e)) _a(n, l);
    ...
    ((t = oa(e, n, l, r)),
      t !== null && ((l = ie()), Re(t, e, r, l), Na(t, n, r)));
  }
}
function Ca(e) {
  var n = e.alternate;
...
function sd(e, n, t, r, l, o, i) {
  if (t)
    return n.flags & 256
      ? ((n.flags &= -257), (r = Vl(Error(y(422)))), pr(e, n, i, r))
      : n.memoizedState !== null
  ...
  if (((u = (i & e.childLanes) !== 0), ce || u)) {
    ...
    return (zi(), (r = Vl(Error(y(421)))), pr(e, n, i, r));
  }
  return l.data === '$?'
    ? ((n.flags |= 128),
      (n.child = e.child),
...
function $a(e) {
  ...
  (n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[De], delete n[Vt], delete n[go], delete n[Gf], delete n[Zf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ha(e, n, t) {
  for (var r = (e.mode & 1) !== 0; x !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && o !== null ? ((o.return = l), (x = o)) : Du(e);
  }
}
function Du(e) {
  for (; x !== null; ) {
...
function Jr(e, n) {
  ...
  while (1);
  if ((ci(), (R = t), (Xr.current = r), K !== null)) throw Error(y(261));
  return ((J = null), (b = 0), X);
}
function yd() {
  for (; K !== null; ) Ya(K);
...
function wd(e, n, t, r) {
  ...
  if (Gr) throw ((Gr = !1), (e = Mo), (Mo = null), e);
  return (
    Zr & 1 && e.tag !== 0 && Zn(),
    (o = e.pendingLanes),
    o & 1 ? (e === Do ? Lt++ : ((Lt = 0), (Do = e))) : (Lt = 0),
    hn(),
    null
  );
}
...
Za = function (e, n, t) {
  ...
  else ((ce = !1), U && n.flags & 1048576 && ea(n, Ar, n.index));
...
gs = Ni;
ws = Ln;
var Ld = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, vs, ys, Ni] },
  vt = {
...
const Rd = () =>
      ...
      children: k.jsx('div', {
        ...
        children: k.jsxs('div', {
          ...
          children: [
            k.jsx('div', {
              className:
                'h-10 w-10 rounded-full bg-gradient-to-br from-indigo-500 to-sky-500 flex items-center justify-center text-white',
              children: k.jsx('i', { className: 'fas fa-brain text-xl' }),
            }),
            k.jsxs('div', {
              children: [
                k.jsx('p', {
                ...
                k.jsx('h1', {
                  ...
                  children: 'Examen Neurológico: Parte 1',
                }),
              ],
            }),
          ],
  ...
  Id = () => k.jsx('i', { className: 'fas fa-compass text-indigo-500' }),
  Od = () => k.jsx('i', { className: 'fas fa-list-check text-indigo-500' }),
  Md = () => k.jsx('i', { className: 'fas fa-star-of-life text-indigo-500' }),
  Dd = () => k.jsx('i', { className: 'fas fa-stethoscope text-indigo-500' }),
  Fd = () =>
    k.jsx('i', { className: 'fas fa-diagram-project text-indigo-500' }),
  Ud = () => k.jsx('i', { className: 'fas fa-clipboard-list text-indigo-500' }),
  $d = () => k.jsx('i', { className: 'fas fa-ranking-star text-indigo-500' }),
  Vd = () => k.jsx('i', { className: 'fas fa-book-open text-indigo-500' }),
  Ad = () => k.jsx('i', { className: 'fas fa-lightbulb text-indigo-500' }),
  Bd = () => k.jsx('i', { className: 'fas fa-toolbox text-indigo-500' }),
  Hd = [
    { href: '#prologo', text: 'Prólogo clínico', icon: k.jsx(Id, {}) },
    {
      href: '#enfoque',
      text: 'Algoritmo de aproximación',
      icon: k.jsx(Od, {}),
    },
    { href: '#puntos-clave', text: 'Puntos clave', icon: k.jsx(Md, {}) },
    {
      href: '#componentes',
    ...
    {
      href: '#mapa-nervios',
      text: 'Mapa de nervios craneales',
      icon: k.jsx(Fd, {}),
    },
    { href: '#checklist', text: 'Guía de práctica', icon: k.jsx(Ud, {}) },
    { href: '#rubrica', text: 'Rúbrica formativa', icon: k.jsx($d, {}) },
    { href: '#guia-estudio', text: 'Guía de estudio', icon: k.jsx(Vd, {}) },
    { href: '#perlas', text: 'Perlas y errores', icon: k.jsx(Ad, {}) },
    { href: '#recursos', text: 'Recursos accionables', icon: k.jsx(Bd, {}) },
  ],
  Wd = () =>
    k.jsx('aside', {
              ...
              k.jsx(
                'a',
                {
                  ...
                  children: k.jsxs('span', {
                    className:
                      'flex items-center gap-3 py-2 px-3 rounded-xl text-sm font-semibold text-slate-600 hover:bg-indigo-50',
  ...
  Qd = ({ id: e, title: n, subtitle: t, children: r }) =>
    k.jsxs('section', {
      id: e,
      className:
        'bg-white border border-slate-200 rounded-3xl shadow-sm p-8 lg:p-12 space-y-8',
      children: [
        k.jsxs('div', {
          className: 'space-y-4',
          children: [
            k.jsx('p', {
              className:
                'text-sm font-semibold uppercase tracking-[0.4em] text-indigo-500',
              children: t,
            }),
            k.jsx('h2', {
  ...
  Wl = ({ title: e, description: n, children: t }) =>
    k.jsxs('div', {
      ...
      children: [
        ...
        k.jsx('p', { className: 'mt-2 text-sm text-slate-600', children: n }),
        k.jsx('div', { className: 'mt-6', children: t }),
      ],
    }),
  Kd = () =>
    k.jsxs(Qd, {
      id: 'guia-estudio',
      subtitle: 'Materiales para el estudiante',
      title: 'Guía de estudio Semana 1: Introducción a la Neurología',
      children: [
        k.jsx('p', {
        ...
        k.jsxs('div', {
          ...
          children: [
            k.jsx(Wl, {
              title: 'Introducción',
              description:
                'Bienvenida a la asignatura, relevancia del razonamiento clínico y objetivos de aprendizaje semanales.',
              children: k.jsxs('ul', {
                ...
                children: [
                  ...
                  k.jsx('li', {
                    children: 'Importancia del examen de tamizaje completo.',
                  }),
                ],
              }),
            }),
            k.jsx(Wl, {
              ...
              description:
                'Diagramas de SNC/SNP, localización anatómica y relación síntoma-vía.',
              children: k.jsxs('ul', {
                className: 'text-sm text-slate-600 space-y-2',
                children: [
                  k.jsx('li', {
                    children: 'Dominio por dominio del estado mental.',
                  }),
                  k.jsx('li', {
                    children:
            ...
            k.jsx(Wl, {
              ...
              children: k.jsxs('ul', {
                ...
                children: [
                  ...
                  k.jsx('li', {
                    children:
                      'NC II: agudeza visual, campos, hemianopsias, fondo y papiledema.',
                  }),
                ],
              }),
            }),
    ...
    k.jsxs(k.Fragment, {
      children: [
        ...
        k.jsx('main', {
          ...
          children: k.jsxs('div', {
            className:
              'grid grid-cols-1 lg:grid-cols-[280px_minmax(0,1fr)] gap-10',
            children: [
              k.jsx(Wd, {}),
              k.jsx('div', {
  ...
  Xd = () =>
    k.jsx('div', {
      className: 'bg-slate-100 min-h-screen text-slate-800',
      children: k.jsx(Yd, {}),
    });
Ql.createRoot(document.getElementById('root-app')).render(
  k.jsx(wc.StrictMode, { children: k.jsx(Xd, {}) }),
);
