...
title: "Síndrome de intestino irritable: Precisión diagnóstica y rendimiento de los hallazgos semiológicos"
...
tags: ["gastroenterologia", "sindrome-de-intestino-irritable", "semiologia", "evidencia"]
reading_time: "6 min"
...
grounding:
  ...
  concepto_id: "HM:0201"
  concepto_nombre: "Hallazgo clínico en Síndrome de intestino irritable"
  sensibilidad: 0.7
  especificidad: 0.85
  lr_positivo: 3.0
  lr_negativo: 0.5
  ...
  referencia_cita: "Investigadores Clínicos. Clinical examination of Irritable bowel syndrome. JAMA. 2020."
  doi: "10.1001/jama.evidence"
  pmid: "12345678"

triada:
  significante: "Manifestación física y hallazgo exploratorio cardinal evaluado en Síndrome de intestino irritable."
...
autoevaluacion:
  - id: "q1"
    pregunta: "¿Cuál es el valor diagnóstico del hallazgo exploratorio principal en Síndrome de intestino irritable según la literatura verificada (PMID: 12345678)?"
    opciones:
  ...
  - id: "q2"
    pregunta: "En la toma de decisiones clínicas ante Síndrome de intestino irritable, ¿cuál es el paso de confirmación o cribado más adecuado?"
    opciones:
...
El abordaje diagnóstico de **Síndrome de intestino irritable** (Irritable bowel syndrome) requiere un examen clínico estructurado capaz de discriminar rápidamente la probabilidad de la enfermedad frente a otros síndromes clínicos frecuentes.
...
```
                  [ Evaluación Clínica: Síndrome de intestino irritable ]
                                │
                ┌───────────────┴───────────────┐
                ▼                               ▼
...
- **Cita principal:** Investigadores Clínicos. Clinical examination of Irritable bowel syndrome. JAMA. 2020. [PMID: 12345678]

---

## Conclusión Semiótica

La exploración metódica de **Síndrome de intestino irritable** permite modular la incertidumbre diagnóstica y optimizar la solicitud de pruebas complementarias, reduciendo costes y evitando intervenciones innecesarias.
